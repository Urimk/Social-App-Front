...
const Message = ({ isOwn }) => {
  return (
    <div className={`flex flex-col ${isOwn ? "" : "items-end"}`}>
      ...
      <div
        className={`flex ${isOwn ? "" : "items-end"} font-poppins text-[var(--gray-500)] dark:text-[var(--gray-300)] 2xl:text-[16px] sm:text-lg-[16px] text-[16.5px] opacity-40 2xl:mt-[3px] mt-lg-[3px]`}
      >
        <div>12:00</div>
