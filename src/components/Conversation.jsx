...
function Conversation() {
  return (
    <div className="flex-1 2xl:min-w-[550px] sm:min-w-lg-[700px] flex flex-col h-screen sm:flex">
      ...
      <MessageList />
      <div className="flex 2xl:pt-[31px] pt-lg-[31px] 2xl:mb-[39px] mb-lg-[39px] 2xl:ml-[56px] sm:ml-lg-[56px] 2xl:mr-[54.5px] sm:mr-lg-[54.5px] border-t-2 border-[var(--gray-500)] dark:border-[var(--gray-100)]">
