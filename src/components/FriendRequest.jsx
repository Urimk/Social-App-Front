  ...
  return (
    <div className="2xl:w-[488px] sm:w-lg-[488px] 2xl:h-[115px] h-lg-[115px] mt-[1px] 2xl:py-[16px] py-lg-[16px] 2xl:px-[14.5px] px-lg-[14.5px] flex 2xl:rounded-[18px] rounded-lg   flex items-center">
      ...
      <button
        ...
        className={`2xl:mx-[20px] sm:mx-lg-[20px] mx-[20px] 2xl:w-[50px] sm:w-lg-[50px] w-[44px]  2xl:h-[38px] sm:h-lg-[38px] h-[38px] 2xl:px-[4x] sm:px-lg-[4px] px-[6px]  font-poppins  rounded-full text-[var(--green-500)]  dark:text-[var(--green-700)] border-2 border-[var(--green-500)] dark:border-[var(--green-700)] bg-[var(--gray-100)] dark:bg-[var(--gray-800)] font-semibold  shadow-md transition duration-300 ease-in-out cursor-pointer`}
      >
        {<Checkmark />}
      </button>
    </div>
