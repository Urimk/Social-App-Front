 ...
 * Displays a modal to confirm account deletion with password input.
 *
 ...
 * @param {Function} props.setIsTop - Function to set top state.
 */
    ...
    >
      <div
        ...
        className="2xl:w-[587px] sm:w-lg-[587px] w-[70vw] bg-white dark:bg-[var(--gray-800)]
          rounded-4xl drop-shadow-[2px_3px_15px_var(--blue-900)] 2xl:py-[51px]
          sm:py-lg-[51px] py-[45px] 2xl:px-[48px] sm:px-lg-[48px] px-[35px] flex flex-col"
      >
        {/* Modal title */}
        <div
          className="2xl:text-[20px] self-center sm:self-auto sm:text-lg-[20px]
