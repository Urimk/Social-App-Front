  ...
  return (
    <div
      ...
      className={`2xl:w-[488px] sm:w-lg-[488px] 2xl:h-[115px] h-lg-[115px] mt-[1px]
        ...
        cursor-pointer transition-colors hover:bg-[var(--gray-100)]/60 dark:hover:bg-[var(--gray-800)]/60
    ...
    >
      ...
      <div
        ...
        2xl:gap-[4px] sm:gap-lg-[4px] gap-[1px] min-w-0"
      >
        <div className="flex justify-between 2xl:w-[350px] sm:w-lg-[350px] w-[63vw]">
          ...
          <div
            ...
            dark:text-[var(--gray-300)] font-poppins opacity-40 shrink-0 ml-2"
          >
            {"20:53"}
          </div>
        </div>
