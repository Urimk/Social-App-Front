...
const Chat = () => {
  return (
    <div>
      <div className="flex flex-col-reverse sm:flex-row w-full h-screen overflow-y-hidden overflow-x-auto dark:bg-[var(--gray-900)]">
        <div className="flex flex-row sm:flex-col justify-center gap-[25vw] sm:gap-0 sm:justify-between h-[10vh] sm:h-full bg-[var(--gray-100)] dark:bg-[var(--gray-800)] 2xl:py-[39px] py-lg-[39px] 2xl:px-[22px] px-lg-[22px] items-center sm:flex hidden">
          ...
          <Logout className="2xl:mb-[41px] sm:mb-lg-[41px] 2xl:w-[25.5px] w-lg-[25.5px] 2xl:h-[23px] h-lg-[23px] dark:brightness-200" />
        </div>
        <div className="flex flex-col 2xl:w-[537px] sm:w-lg-[537px] w-screen h-screen bg-white dark:bg-[var(--gray-900)] 2xl:px-[22px] px-[5vw] sm:px-lg-[22px] 2xl:pt-[39px] pt-lg-[39px] sm:border-r-3 border-[var(--gray-100)] sm:flex hidden">
          ...
          <div className="relative 2xl:w-[476px] sm:w-lg-[476px] ">
            <input
              type="text"
              placeholder="Search"
              className="sm:w-full 2xl:mb-[21px] w-[84vw] sm:mb-lg-[21px] my-[2vh] 2xl:pl-[40px] pl-lg-[40px] 2xl:pr-[15px] pr-lg-[15px] 2xl:py-[8px] py-lg-[8px] 2xl:ml-[15px] sm:ml-lg-[15px] mx-[3vw] bg-[var(--gray-100)] 2xl:h-[39px] sm:h-lg-[39px] 2xl:mt-[12px] sm:mt-lg-[12px]  rounded-2xl focus:outline-none focus:ring-1 focus:ring-[var(--blue-500)] focus:dark:ring-[var(--blue-400)] transition-all duration-200 ease-in-out placeholder:text-[var(--gray-500)] dark:placeholder:text-[var(--gray-300)] dark:text-white 2xl:text-[16px] sm:text-lg-[16px] text-[18px] font-poppins dark:bg-(--gray-600) focus:dark:ring-[var(--blue-500)]"
            ></input>
            <Search className="absolute 2xl:w-[12.5px] sm:w-lg-[12.5px] w-[3vw] 2xl:bottom-[27px] sm:bottom-lg-[24px] bottom-[6vw] 2xl:left-[34px] left-lg-[34px] text-[var(--gray-500)]  dark:brightness-200  font-thin" />
          </div>
          <div className="flex-1 min-h-0">
            <SimpleBar className="h-full auto-padding-scrollbar">
              <div className="flex 2xl:ml-[8px] ml-lg-[8px] font-poppins text-[var(--gray-500)] dark:text-[var(--gray-300)] 2xl:text-[16px] sm:text-lg-[16px] sm:mb-lg-[5px] mb-[0.5vh] text-[18px] items-center justify-between">
                <div>Pinned Conversations</div>
                <div className="font-semibold">...</div>
              </div>
              <ContactList />
              <div className="flex 2xl:mt-[21px] mt-lg-[21px] 2xl:mb-[5px] sm:mb-lg-[5px] mb-[0.5vh] 2xl:ml-[8px] ml-lg-[8px] font-poppins text-[var(--gray-500)] dark:text-[var(--gray-300)] 2xl:text-[16px] sm:text-lg-[16px] text-[18px] items-center justify-between">
                <div>All</div>
                <div className="font-semibold">...</div>
              </div>
              <ContactList />
